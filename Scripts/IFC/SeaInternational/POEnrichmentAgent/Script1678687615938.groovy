...
//if(WebUI.verifyElementClickable(findTestObject('Object Repository/SeaTriangleEnrichment/Page_IFC Global Logistics/span_Confirm Products for Booking Proposal'))) {
