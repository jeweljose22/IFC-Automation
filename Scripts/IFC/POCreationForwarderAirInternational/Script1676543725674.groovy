...
String randomNumber = 'PO-TEST-'+(int)(Math.random() * 4900)
...
WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/span_Add New PO'))

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/a_Air Freight'))



WebUI.setText(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/input_PO Number_poNumber'), 
    randomNumber)

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/div_Enter Client Name to select_react-selec_dfc0a4'))

WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_'+clientName))

WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_Enter Vendor Name to select_react-selec_b2e85c'))

WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_'+vendorName))

WebUI.verifyElementClickable(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/span_Submit'))

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/span_Submit'))

WebUI.delay(7)

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/button_Add Details'))

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/div_Enter Origin to select_css-ackcql'))

WebUI.setText(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/input__react-select-4-input'), 
    'AUMEL')
...
WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_Melbourne(AUMEL)'))

WebUI.click(findTestObject('Object Repository/POCreationForwarderAirInternational/Page_IFC Global Logistics/div_Enter Destination to select_css-ackcql'))
...
WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_Kerang(AUKRA)'))
...
WebUI.click(findTestObject('Object Repository/Page_IFC Global Logistics/div_GROCERY CORPORATION (1)'))
